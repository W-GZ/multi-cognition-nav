...
# print(Path.cwd())
# print(os.path.relpath(ROOT, Path.cwd()))
...
# python train.py --data coco128.yaml --weights yolov3.pt --img 640
# python train.py --weights yolov3.pt --data coco128.yaml --img 640 --batch 16 --epochs 5
